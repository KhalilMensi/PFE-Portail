...
namespace PortailEbook.Models
{
    ...
    {
       static string DbConnnectionString = @"Data Source=DESKTOP-A5NHULB\SQLEXPRESS;Initial Catalog=Portail;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
